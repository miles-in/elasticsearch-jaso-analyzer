# Korean Jaso Analyzer for Elasticsearch 7.10.2
...
###### 자동완성용 한글 자소분석기입니다. elasticsearch 7.10.2 에서 테스트 되었습니다

###### *설치*
```
bin/elasticsearch-plugin install https://github.com/netcrazy/elasticsearch-jaso-analyzer/releases/download/v7.10.2/jaso-analyzer-plugin-7.10.2-plugin.zip
```
